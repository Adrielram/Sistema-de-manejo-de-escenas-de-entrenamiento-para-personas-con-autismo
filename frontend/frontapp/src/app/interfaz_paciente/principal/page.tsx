...
const PacientePrincipal = () => {
  ...
  return (
    <div className="md:min-h-screen w-full flex items-start md:items-center justify-center md:justify-start p-0 pt-4 md:p-8 bg-[#f5af76]">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-center md:justify-between gap-16 md:gap-32 h-full">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <button onClick={HandleOnClickEsc} className="px-8 py-4 md:px-16 md:py-8 text-lg md:text-3xl font-bold text-white bg-blue-600 rounded-xl shadow-lg hover:bg-blue-700 transition-colors duration-300">
            VER ESCENAS
          </button>
        </div>
      </div>
