...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        terapeutas = [
            {"dni": 4001, "nombre": "Paqui1", "residencia": residencia_1},
            {"dni": 4002, "nombre": "Paqui2", "residencia": residencia_1},
            {"dni": 4003, "nombre": "Paqui3", "residencia": residencia_2},
            {"dni": 4004, "nombre": "Paqui4", "residencia": residencia_2},
        ]
