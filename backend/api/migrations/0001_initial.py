# Generated by Django 5.1.4 on 2025-02-08 12:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('escena', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registros', to='api.escena')),
                ('objetivo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registros', to='api.objetivo')),
                ('paciente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='registros', to=settings.AUTH_USER_MODEL)),
                ('patologias', models.ManyToManyField(related_name='registros', to='api.patologia')),
            ],
            options={
